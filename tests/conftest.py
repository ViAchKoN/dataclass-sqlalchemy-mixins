...
TEST_DB_URL = (
    "postgresql://{POSTGRES_CREDENTIALS}{POSTGRES_HOST}/pydantic_sqlalchemy_filters_test"
)
...
TEST_DB_URL = TEST_DB_URL.format(POSTGRES_CREDENTIALS=POSTGRES_CREDENTIALS,POSTGRES_HOST=POSTGRES_HOST)
